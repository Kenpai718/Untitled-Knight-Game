class Portal extends AbstractInteractable {
    constructor(game, x, y) {
        ...
        this.animation = new Animator(this.spritesheet, 0, 0, 320, 320, 40, 0.1, 0, false, true, false);
    ...
    draw(ctx) {
        if (this.state == this.states.idle) {
            ctx.drawImage(this.spritesheet, 0, 0, 320, 320, this.x * this.scale - this.game.camera.x, this.y * this.scale - this.game.camera.y, this.scale * 3, this.scale * 3);
        } else {
            //console.log("fjei");
            this.animation.drawFrame(this.game.clockTick, ctx, this.x * this.scale - this.game.camera.x, this.y * this.scale - this.game.camera.y, this.scale * 3);
        }
