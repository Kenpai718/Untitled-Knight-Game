    ...
    */
    ...
    summonArrows(theAmount) {
        ...
        for (let i = 0; i < theAmount; i++) {
            ...
            if (arrow.BB.left < this.left * PARAMS.BLOCKDIM)
                arrow.x += this.left * PARAMS.BLOCKDIM + 32 - arrow.BB.left;
            if (arrow.BB.right > this.right * PARAMS.BLOCKDIM)
                arrow.x += this.right * PARAMS.BLOCKDIM - 32 - arrow.BB.right;
            arrow.updateBB();
