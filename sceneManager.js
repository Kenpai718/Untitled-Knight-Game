class SceneManager {
    ...
    viewDebug(ctx) {;
        // left debug
        ctx.lineWidth = 2;
        ctx.strokeStyle = this.game.keys[this.player.left] ? "Red" : "SpringGreen";
        ...
        // down debug
        ctx.lineWidth = 2;
        ctx.strokeStyle = this.game.keys[this.player.down] ? "Red" : "SpringGreen";
        ctx.fillStyle = ctx.strokeStyle;
        ...
        // up debug
        ctx.lineWidth = 2;
        ctx.strokeStyle = this.game.keys[this.player.up]  ? "Red" : "SpringGreen";
        ctx.fillStyle = ctx.strokeStyle;
        ...
        // right debug
        ctx.lineWidth = 2;
        ctx.strokeStyle = this.game.keys[this.player.right]  ? "Red" : "SpringGreen";
        ctx.fillStyle = ctx.strokeStyle;
        ...
        // jump debug
        ctx.lineWidth = 2;
        ctx.strokeStyle = this.game.keys[this.player.jump]  ? "Red" : "SpringGreen";
        ctx.fillStyle = ctx.strokeStyle;
		...
		// roll debug
		ctx.lineWidth = 2;
		ctx.strokeStyle = this.game.keys[this.player.roll]  ? "Red" : "SpringGreen";
		ctx.fillStyle = ctx.strokeStyle;
        ...
        ctx.lineWidth = 2;
        ctx.strokeStyle = this.game.keys[this.player.attack]  ? "Red" : "SpringGreen";
        ctx.fillStyle = ctx.strokeStyle;
